...
<Columns cols={2}>
  <Column>
    <Card title="Правила Использования API" href="/ru/policies/api-use-guidelines" img="/images/api-rules.png">
      Узнайте, как правильно работать с API, чтобы избежать блокировок и ошибок.
    </Card>
  </Column>
  <Column>
    <Card title="Документация API V2" href="/ru/api-reference/api-v2" img="/images/api-v2.png">
...
<Columns cols={2}>
  <Column>
    <Card title="Документация API V1" href="/ru/api-reference/api-v1" img="/images/api-v1.png">
      Узнайте, как правильно работать с API, чтобы избежать блокировок и ошибок.
    </Card>
  </Column>
  <Column>
